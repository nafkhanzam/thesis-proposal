...
Output dari pelatihan tersebut merupakan graf \AMR{} yang dilinearisasi, yaitu \code{<g>g1,g2,...,gm</g>}.
Linearisasi graf menggunakan algoritma \gls{DFS} \citek{bevilacqua2021}.

\begin{filecontents*}{3-pt-ft-strategies.csv}
Phase,Task,Input
PT,\code{$\bar{t}\bar{t}\hat{g}2g$},\makecell[cl]{\codesm{<id>[mask]</id><en>[mask]</en>}\codesm{<g>g1,..[mask]..,gm</g>}}
,\code{$t\bar{t}\hat{g}2g$},\makecell[cl]{\codesm{<id>a1,a2,...,an1</id><en>[mask]</en>}\codesm{<g>g1,..[mask]..,gm</g>}}
,\code{$\bar{t}t\hat{g}2g$},\makecell[cl]{\codesm{<id>[mask]</id><en>b1,b2,...,bn2</en>}\codesm{<g>g1,..[mask]..,gm</g>}}
,\code{$tt\hat{g}2g$},\makecell[cl]{\codesm{<id>a1,a2,...,an1</id><en>b1,b2,...,bn2</en>}\codesm{<g>g1,..[mask]..,gm</g>}}
,\code{$t\hat{t}\hat{g}2g$},\makecell[cl]{\codesm{<id>a1,a2,...,an1</id><en>b1,..[mask]..,bn2</en>}\codesm{<g>g1,..[mask]..,gm</g>}}
,\code{$\hat{t}t\hat{g}2g$},\makecell[cl]{\codesm{<id>a1,..[mask]..,an1</id><en>b1,b2,...,bn2</en>}\codesm{<g>g1,..[mask]..,gm</g>}}
,\code{$\hat{t}\hat{t}\hat{g}2g$},\makecell[cl]{\codesm{<id>a1,..[mask]..,an1</id><en>b1,..[mask]..,bn2</en>}\codesm{<g>g1,..[mask]..,gm</g>}}
FT,\code{$t\bar{t}\bar{g}2g$},\makecell[cl]{\codesm{<id>a1,a2,...,an1</id><en>[mask]</en>}\codesm{<g>[mask]</g>}}
\end{filecontents*}
