...
Sesuai dengan skema pelatihan \ti{bilingual}, kalimat berbahasa Inggris dan Indonesia dilinearisasi secara sejajar sebagai input \pretraining{} maupun \finetuning{}.
...
\tabl{3-pt-ft-strategies}
  {sections/chapter-3/3-pt-ft-strategies.csv}
  {
    ...
    \code{a1,a2,...,an1} merupakan token untuk Bahasa Inggris, sedangkan \code{b1,b2,...,bn2} merupakan token untuk Bahasa Indonesia.
