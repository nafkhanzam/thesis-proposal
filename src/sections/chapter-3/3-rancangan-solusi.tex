...
Filtrasi dilakukan dengan melakukan translasi kembali ke Bahasa Inggris, lalu dilakukan algoritma 1-NN dengan \cossim{} sebagai nilai kedekatan antar dua kalimat.
