...
Namun dengan baseline dari \ti{pipeline translate-and-parse} yang memiliki skor \SMATCH{} 62.5, model tersebut masih belum dapat melampaui kinerja baseline.
\textcite{putra2022} menggunakan model \gls{stog} \citek{zhang2019} yang bukan lagi \ti{state of the art} \amrparsing{} saat ini.
