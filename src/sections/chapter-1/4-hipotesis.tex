...
\premise Teknik graf \pretraining{} \gls{AMRBART} oleh \textcite{bai2022} yang menggunakan \ti{language model} BART merupakan teknik yang menghasilkan kinerja \amrparsing{} terbaik berdasarkan metrik SMATCH.
