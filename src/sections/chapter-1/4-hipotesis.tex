...
Hasil kinerja model tersebut dapat menghasilkan evaluasi yang lebih baik dari \textit{baseline} yang menggunakan teknik \textit{translate-and-parse} oleh \textcite{uhrig2021}.
