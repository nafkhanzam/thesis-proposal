...
\premise Teknik graf \pretraining{} AMRBART oleh \textcite{bai2022} yang menggunakan \ti{language model} BART merupakan teknik yang menghasilkan kinerja \amrparsing{} terbaik berdasarkan metrik SMATCH.
