...
Dengan keterbatasan jumlah dataset yang dipunya untuk melatih model \ti{cross-lingual}, framework ini menghasilkan lebih banyak pasangan graf \AMR{} dan kalimat dengan bahasa yang dituju.
