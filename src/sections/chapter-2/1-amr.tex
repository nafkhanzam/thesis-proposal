...
\gls{AMR} awalnya dibuat untuk kalimat berbahasa Inggris dan tidak digunakan sebagai bahasa secara umum \citek{banarescu2013}.

\gls{AMR} menggunakan \textit{framesets} PropBank \citek{kingsbury2002} secara ekstensif untuk merepresentasikan predikat yang ada dalam kalimat.
...
\begin{enumerate}
  ...
  Contoh sebuah graf \gls{AMR} dari kalimat \quotei{the boy wants to go} dapat dilihat pada \cref{fig:amr-graph-example}.

  \fig{amr-graph-example}{sections/chapter-2/1-amr-graph-example.png}
    {Contoh sebuah graf \gls{AMR} dari kalimat \quotei{the boy wants to go} \citek{banarescu2013}.}
  ...
  Contoh sebuah \gls{AMR} dari kalimat \quotei{the boy wants to go} dalam format PENMAN dapat dilihat pada \cref{fig:amr-penman-example}.

  \fig{amr-penman-example}{sections/chapter-2/1-amr-penman-example.png}
    {Contoh sebuah \gls{AMR} dari kalimat \quotei{the boy wants to go} dalam format PENMAN \citek{banarescu2013}.}

  \item Format logika.

  Format logika merepresentasikan keterhubungan antar simpul dan/atau sisi dari graf.
  Contoh sebuah \gls{AMR} dari kalimat \quotei{the boy wants to go} dalam format logika dapat dilihat pada \cref{fig:amr-logic-example}.

  \fig{amr-logic-example}{sections/chapter-2/1-amr-logic-example.png}
    {Contoh sebuah \gls{AMR} dari kalimat \quotei{the boy wants to go} dalam format logika \citek{banarescu2013}.}
\end{enumerate}
