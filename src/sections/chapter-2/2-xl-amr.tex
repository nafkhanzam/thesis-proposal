...
Properti \ti{cross-lingual} dari \AMR{} di berbagai bahasa merupakan subjek yang sering dibahas.
...
\textcite{blloshmi2020} mengusulkan konfigurasi dalam melakukan training untuk \amrparsing{} \ti{cross-lingual}.
