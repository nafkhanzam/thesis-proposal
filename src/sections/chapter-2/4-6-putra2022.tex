...
\fig[0.7]{4-6-solution-diagram}{sections/chapter-2/4-6-solution-diagram.png}{Gambaran keseluruhan sistem rancangan solusi pembangunan model \ti{cross-lingual} untuk Bahasa Indonesia \citek{putra2022}.}
