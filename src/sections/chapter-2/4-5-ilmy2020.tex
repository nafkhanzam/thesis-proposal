...
Pendekatan yang digunakan adalah pendekatan menggunakan hasil \ti{dependency parsing} untuk mengetahui hubungan antar kata.
...
\begin{enumerate}
  ...
  \item Melakukan \ti{post-process} dari kandidat pasangan berlabel untuk menghasilkan graf AMR yang valid.
\end{enumerate}
