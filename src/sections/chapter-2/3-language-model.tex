...
Salah satu pengembangan \ti{encoder} dari model transformer adalah \glsfirst{BERT}.
...
\textcite{bi2020} mengusulkan \glsfirst{PALM} dengan adanya skema yang menggabungkan \pretraining{} \ti{auto-encoding} dan \ti{autoregressive} \ti{language model} pada korpus besar tak berlabel.
\gls{PALM} didesain untuk mengenerasi teks baru yang bergantung pada konteks.
Skema ini menangani ketidakcocokan antara teknik \pretraining{} dan \ti{fine-tuning} yang ada sebelumnya.
